...
<head>
    <meta charset="UTF-8">
    <title>Gestionar Empleados - SkinLabs</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/png" href="../../assets/img/favicon.png" />
    <link rel="stylesheet" href="../../assets/css/gestionar_profesionales.css"> <!-- usás el mismo CSS -->
...
<nav class="navbar navbar-dark bg-primary px-3">
    ...
    <a href="/2025/SkinLabs/logout.php" class="btn btn-danger ms-3">Cerrar sesión</a>
</nav>
...
<script src="../../assets/js/editar_empleado.js"></script>
